class ModelNotFoundException implements Exception {
  ...
  @override String toString() => 'ModelNotFoundException: $message';
}

class InferenceException implements Exception {
  final String message;
  const InferenceException(this.message);
  @override String toString() => 'InferenceException: $message';
}

class CameraException implements Exception {
  final String message;
  const CameraException(this.message);
  @override String toString() => 'CameraException: $message';
}
...
class ImageConversionException implements Exception {
  ...
  @override String toString() => 'ImageConversionException: $message';
}